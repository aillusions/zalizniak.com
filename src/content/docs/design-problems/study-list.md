...
The system-design questions worth practicing, grouped into patterns so no shape catches you cold. For the vocabulary that comes up along the way, see [Terminology](/system-design/terminology/).
