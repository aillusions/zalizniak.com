...
# compute, no managed Next.js routing. Much simpler than a WEB_COMPUTE app:
# Amplify just serves the prerendered files behind its CloudFront CDN.
...
# Custom domain: serve the site at the apex (zalizniak.com) AND at www. Amplify
