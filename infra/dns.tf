# DNS in the existing zalizniak.com Route 53 hosted zone.
#
...
# Apex zalizniak.com -> Amplify CloudFront. Must be an A-record ALIAS: you can't
# CNAME a zone apex.
...
# www.zalizniak.com -> Amplify CloudFront. Published as an A-record ALIAS (not a
# CNAME) so it cleanly overwrites the pre-existing www A-alias without a
